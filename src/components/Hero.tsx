        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-primary-foreground mb-6 leading-tight drop-shadow-2xl">
              {t("hero.title.line1")}
              <span className="block text-primary drop-shadow-lg mt-2">
                {t("hero.title.line2")}
              </span>
            </h1>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <a href="#products">
                <Button
                  variant="hero"
                  size="lg"
                  className="text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 font-semibold hover-scale"
                >
            ...
            {/* Trust Indicators */}
            <div
              className={`flex flex-wrap justify-center items-center gap-3 sm:gap-4 lg:gap-6 text-primary-foreground/90 drop-shadow-md transition-opacity duration-500 ${
